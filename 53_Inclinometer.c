 ...
 *                      the use of the MPU6050 as am IMU being an inclinometer 
 * 
 ...
 *                       SCL  -> PC2 
 *           
 * Created August 25th, 2025, 10:41 PM
 * Updated August 25th, 2025, 10:41 PM
 */
...
/*******************************************************************************
 * UI: Degree Text and LED level with hysteresis
 ******************************************************************************/
...
int main(void)
{
    ...
    printf("SystemClk:%ld\r\n", SystemCoreClock);
    printf("CH32V003 + MPU-6050 (I2C @ 400kHz) — Inclinometer (deg, no libm)\r\n");
    ...
    while (1){
        ...
        if (mpu_read_raw(&r)){
            ...
            if ((tick % 10) == 0){
                print_inclinometer_line(roll_cdeg, pitch_cdeg, s_ax, s_ay, s_az, temp_to_c_x100(r.temp));
