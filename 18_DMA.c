 ...
 * Program: 18_Direct_Memory_Access
 * Compiler: WCH Toolchain (GCC8, MounRiver Studio v2.20)
 * Program Version: 1.1
 *                  * Cleaned up code
 *                  * Added additional comments
 *                
 * Program Description: In this example we use the CH32V003F4P6 to demonstrate 
 *                      direct memory access. Modified from EVT example from 
 *                      WCH 
 *
 * Hardware Description: The WCH-Link is used to send dat via UART 
 *
 * Created:  August  23rd, 2025, 3:31 PM
 * Updated:  January 04th, 2026, 8:41 AM
 */
