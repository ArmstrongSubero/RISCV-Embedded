 ...
 * Program: 18_Sine_Wave_Generation 
 ...
 *                      the production of a sincewave using DMA 
 *                      
 * Hardware Description: A low pass filter is created on PD2 with a 1k resistor 
 *                       and a 100 nF capacitor 
 *           
 * Created August  21st, 2025, 10:06 PM
 * Updated January 04th, 2025, 01:42 PM 
 */
